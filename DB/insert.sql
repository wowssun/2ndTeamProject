...
Insert into JEJUOSEYO.HOST (HID,REP,HPW,HNICK,HPHONE,DNUMBER,HEMAIL,CRNUM,PHOTO,REG_DATE,PROC_STATE,PROC_DATE) values ('sky123','김하늘','Sunny#2023','하늘하늘','01055558888','0311122334','sky123@example.com','2222222222','2',to_date('23/08/02','RR/MM/DD'),'승인',to_date('23/08/02','RR/MM/DD'));

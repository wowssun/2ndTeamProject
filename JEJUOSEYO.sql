...
Insert into JEJUOSEYO.HOST (HID,REP,HPW,HNICK,HPHONE,DNUMBER,HEMAIL,CRNUM,PHOTO,REG_DATE,PROC_STATE,PROC_DATE) values ('testa','김민','testa!!!','민민민','01036382738','0648373927','siwoo@example.com','5744400655','31.jpeg',to_date('23/08/15','RR/MM/DD'),'승인',to_date('23/08/15','RR/MM/DD'));
...
--여행메이트
INSERT INTO J_MEMBER (mid, name, mpw, mnick, memail, mphone, reg_date)
VALUES ('user123', 'John Doe', 'password123', 'johndoe', 'johndoe@example.com', '123-456-7890', TO_DATE('2023-08-10', 'YYYY-MM-DD'));

INSERT INTO J_MEMBER (mid, name, mpw, mnick, memail, mphone, reg_date)
VALUES ('traveler456', 'Jane Smith', 'pass456', 'janesmith', 'jane.smith@example.com', '987-654-3210', TO_DATE('2023-08-10', 'YYYY-MM-DD'));

INSERT INTO J_MEMBER (mid, name, mpw, mnick, memail, mphone, reg_date)
VALUES ('adventurer789', 'Michael Johnson', 'secret789', 'mikej', 'michael.j@example.com', '555-123-4567', TO_DATE('2023-08-11', 'YYYY-MM-DD'));

INSERT INTO J_MEMBER (mid, name, mpw, mnick, memail, mphone, reg_date)
VALUES ('explorer234', 'Emily Brown', 'hidden234', 'emilyb', 'emily.b@example.com', '444-567-8901', TO_DATE('2023-08-11', 'YYYY-MM-DD'));

INSERT INTO J_MEMBER (mid, name, mpw, mnick, memail, mphone, reg_date)
VALUES ('beachlover567', 'Alex Davis', 'beach567', 'alexd', 'alex.d@example.com', '222-789-0123', TO_DATE('2023-08-12', 'YYYY-MM-DD'));

INSERT INTO MATE (mno, mnick, mtitle, mhit, depart, fin, mplace, mnum, mtext, mdate)
VALUES (1, 'johndoe', '발리 여행 메이트 찾습니다', 120, TO_DATE('2023-08-15', 'YYYY-MM-DD'), TO_DATE('2023-08-25', 'YYYY-MM-DD'), '발리, 인도네시아', 2, '발리로 여행을 계획하고 있습니다. 같이 가실 분 찾아요!', TO_DATE('2023-08-05', 'YYYY-MM-DD'));

INSERT INTO MATE (mno, mnick, mtitle, mhit, depart, fin, mplace, mnum, mtext, mdate)
VALUES (2, 'janesmith', '스페인 바르셀로나 함께 둘러보실 분', 85, TO_DATE('2023-09-20', 'YYYY-MM-DD'), TO_DATE('2023-09-30', 'YYYY-MM-DD'), '바르셀로나, 스페인', 1, '바르셀로나에서 함께 관광할 메이트를 찾습니다.', TO_DATE('2023-08-12', 'YYYY-MM-DD'));

INSERT INTO MATE (mno, mnick, mtitle, mhit, depart, fin, mplace, mnum, mtext, mdate)
VALUES (4, 'emilyb', '일본 도쿄 여행 같이 가실 분 찾아요', 92, TO_DATE('2023-10-05', 'YYYY-MM-DD'), TO_DATE('2023-10-15', 'YYYY-MM-DD'), '도쿄, 일본', 2, '도쿄로 여행을 준비 중입니다. 같이 가실 분 환영해요!', TO_DATE('2023-09-15', 'YYYY-MM-DD'));

INSERT INTO MATE (mno, mnick, mtitle, mhit, depart, fin, mplace, mnum, mtext, mdate)
VALUES (5, 'alexd', '멕시코 리조트동행자 모집', 68, TO_DATE('2023-11-10', 'YYYY-MM-DD'), TO_DATE('2023-11-20', 'YYYY-MM-DD'), '칸쿤, 멕시코', 1, '멕시코의 아름다운 리조트에서 휴가를 함께 보낼 메이트를 찾습니다.', TO_DATE('2023-10-25', 'YYYY-MM-DD'));

 -- 여행메이트 댓글
INSERT INTO MATECM (mcmno, mno, mnick, mcmtext, mcmdate)
VALUES (1, 1, 'johndoe', '발리 여행 계획 멋져요!', TO_DATE('2023-08-12', 'YYYY-MM-DD'));

INSERT INTO MATECM (mcmno, mno, mnick, mcmtext, mcmdate)
VALUES (2, 1, 'janesmith', '발리로 같이 가면 좋겠네요!', TO_DATE('2023-08-13', 'YYYY-MM-DD'));

INSERT INTO MATECM (mcmno, mno, mnick, mcmtext, mcmdate)
VALUES (4, 4, 'emilyb', '도쿄 여행을 기대하고 있어요!', TO_DATE('2023-08-15', 'YYYY-MM-DD'));

-- 여행메이트 신청
INSERT INTO MATEAPPLY (ano, mnick, mno, mnow)
VALUES (1, 'johndoe', 1, '대기');

INSERT INTO MATEAPPLY (ano, mnick, mno, mnow)
VALUES (2, 'janesmith', 2, '수락');

INSERT INTO MATEAPPLY (ano, mnick, mno, mnow)
VALUES (3, 'mikej', 3, '대기');

INSERT INTO MATEAPPLY (ano, mnick, mno, mnow)
VALUES (4, 'emilyb', 4, '거절');

INSERT INTO MATEAPPLY (ano, mnick, mno, mnow)
VALUES (5, 'alexd', 5, '대기');

 -- 여행메이트 위시리스트(찜) 테이블에 데이터 추가
INSERT INTO MATEWISH (mwno, mno, mid)
VALUES (1, 1, 'johndoe');

INSERT INTO MATEWISH (mwno, mno, mid)
VALUES (2, 2, 'janesmith');
